        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.clinic.image) {
                    $('#imageClinic').prepend(`<img style="object-fit: cover;" class="img-info-clinic" src="/images/clinics/${data.clinic.image}" />`)
                } else {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.doctor.avatar) {
                    $('#imageDoctor').prepend(`<img style="object-fit: cover;" class="img-info-clinic" src="/images/users/${data.doctor.avatar}" />`)
                } else {
